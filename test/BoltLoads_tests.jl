...
display(plot_bolt_loads(p3, Fc = Fc1, Mc = Mc1, load_format = "kN", length_format = "mm"))


# rectangle
p4 = rectangle(x_dist = 250mm, y_dist = 125mm, Nx = 3, Ny=4)
BL4 = bolt_loads(p4, Fc = Fc1, Mc = Mc1)
display(plot_bolt_loads(p4, Fc = Fc1, Mc = Mc1))
...
display(plot_bolt_loads(p5, Fc = Fc1, Mc = Mc1))
